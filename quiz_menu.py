...
class QuizMenu:
    def __init__(self):
        ...
        self.selected_option.set("Erkenne die Diagnose")
    ...
    def modeSelect(self):
        ...
        dropdown = ttk.Combobox(mode_frame, textvariable=self.selected_option, values=["Erkenne die Diagnose", "Blutbildwerte eingrenzen", "Errate den Marker"], state="readonly", width=20, font=("Arial", 14))
