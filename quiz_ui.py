...
class QuizInterface:
    ...
    def __init__(self, quiz_logic: QuizLogic) -> None:
        ...
        self.feedback = Label(self.window,
                              ...
                              pady=10,
                              font=("Arial", 15, "bold"))
        self.feedback.place(relx=0.515,
                            y=720,
                            anchor="center")
    ...
    def cheatSheet(self):
        ...
        canvas = Canvas(novi, width=850, height=700, bg="lightblue")
        canvas.pack(expand="yes", fill="both")
        # Laden Sie das Bild für den Spickzettel
        spickzettel_image = PhotoImage(file="spickzettel_r.png")
        canvas.create_image(30, 10, image=spickzettel_image, anchor="nw")
    ...
    def buttons(self):
        ...
        cheatSheet = Button(self.window,
                            ...
                            fg="white",
                            font=button_font)
        cheatSheet.place(relx=0.94, rely=0.38, anchor="s")
